...
<gameSystem id="49cd-4f53-908d-4074" name="Maelstrom&apos;s Edge" revision="8" battleScribeVersion="2.03" authorName="Marten" authorContact="medgebattlescribe@gmail.com" authorUrl="www.maelstromsedge.com" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <publications>
  ...
  <profileTypes>
    ...
    <profileType id="ad49-3824-6f60-a70d" name="Additional Units">
      <characteristicTypes>
        <characteristicType id="c76e-aa66-07f5-b32c" name="Command"/>
        <characteristicType id="9079-9375-3bba-fe83" name="Core"/>
        <characteristicType id="a174-8465-d170-31df" name="Hammer"/>
        <characteristicType id="e3f8-e48b-4bd7-c762" name="Vanguard"/>
        <characteristicType id="9864-9b45-5352-52a6" name="Anvil"/>
      </characteristicTypes>
    </profileType>
  </profileTypes>
  <categoryEntries>
...
·         Explode: When a large model becomes a casualty, it explodes on a 5+. This causes a special attack emanating from the base of the model using the model’s MAS vs. the targets’ EVS. Explosion profile: RNG=1/2MAS+D3&quot; SHO=MASx2 PEN=MAS DAM=1.</description>
    ...
    <rule id="dc11-7141-9697-0e7c" name="EMP (X+)" publicationId="49cd-4f53-pubd1e201" page="76" hidden="false">
...
3) Vehicles cannot perform a Charge action, and cannot perform reactive CQ fighting.</description>
    ...
    <rule id="f6f1-8217-d3b5-a1cb" name="Aerial Insertion" hidden="false">
      <description>(exclusive ability) When performing a Dash action from reserve, this unit can make an unlimited range dynamic move, but cannot end within 6” of the enemy or be on the move. If ending this dynamic move touching an obstacle or area terrain, it gains +2D3 STs. When returning to the game as a reinforcement, this unit may only utilize aerial insertion if you expend 1 command point (from your command point pool).</description>
    </rule>
    <rule id="9016-a51f-2565-b49d" name="Phase" hidden="false">
      <description>Cannot be ignored by a Field.</description>
    </rule>
  </sharedRules>
</gameSystem>